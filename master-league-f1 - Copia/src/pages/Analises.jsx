...
function Analises() {
    ...
    const [activeTab, setActiveTab] = useState(initialTab); // 'acusacao', 'defesa', 'consulta', 'stewards'
    ...
    useEffect(() => {
        const verificarAuth = async () => {
            try {
                ...
                if (!user) {
                    // Usuário não logado - permitir acesso sem login
        ...
        <div style={{ minHeight: '100vh', background: 'var(--bg-dark-main)', color: 'white', padding: '80px 20px 40px', fontFamily: "'Montserrat', sans-serif" }}>
            <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
                ...
                <div style={{ 
                    ...
                    >
                        <span style={{ fontSize: '1.1rem' }}>⚖️</span> Enviar Acusação
                    </button>
                    <button
                    ...
                    >
                        <span style={{ fontSize: '1.1rem' }}>🛡️</span> Enviar Defesa
                    </button>
                    <button
                    ...
                    >
                        <span style={{ fontSize: '1.1rem' }}>📋</span> Consultar Lances
                    </button>
                    <button
                    ...
                    >
                        <span style={{ fontSize: '1.1rem' }}>👨‍⚖️</span> Stewards ADM
                    </button>
                </div>

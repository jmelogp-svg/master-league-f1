        ...
        <div className="page-wrapper">
            <nav className="navbar">
                ...
                <div className="nav-actions">
                    <button onClick={() => navigate(-1)} className="btn-back"><ArrowBackIcon /> <span className="hide-mobile">VOLTAR</span></button>
                    <Link to="/" className="btn-hub"><HubIcon /> <span className="hide-mobile">HUB</span></Link>
                </div>
            </nav>
            ...
            <div className="login-section">
                <div className="login-card">
                    ...
                    <p className="login-subtitle">Faça login para acessar sua Super Licença e Estatísticas.</p>

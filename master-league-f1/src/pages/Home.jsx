                    ...
                    <header className="hub-hero">
                        ...
                        <div className="hero-content">
                            ...
                            <div className="hero-actions">
                                <button className="btn-primary" onClick={() => navigate('/?view=drivers')}>VER CLASSIFICAÇÃO</button>
                    ...
                    <div className="hub-container">
                        ...
                        <section className="hub-section">
                            ...
                            <div className="quick-links-grid">
                                ...
                                <Link to="/analises" className="ql-card style-analises"><div className="ql-icon">📊</div><div className="ql-info"><h3>ANÁLISES</h3><span>Telemetria</span></div></Link>
                ...
                <div className="hub-container">
                    <section className="standings-section">
                        <div className="tabs-container">
                            ...
                            <button className={`tab-btn ${viewType === 'calendar' ? (gridType === 'carreira' ? 'active-tab-carreira' : 'active-tab-light') : ''}`} onClick={() => navigate('/?view=calendar')}>CALENDÁRIO</button>
                        </div>
                        <div className="section-header">
                            ...
                            <div className="controls-wrapper">
                                ...
                                <div className="dropdown-group">
                                    {/* CORREÇÃO: O Dropdown agora mostra todas as opções. A validação é feita no render. */}
